...
HOTKEY_ACTIONS_CONFIG = {
    ...
    # "toggle_mouse_ignore_independent": {"desc_key": "hotkey_desc_toggle_mouse_ignore", "signal_name": "action_toggle_mouse_ignore_independent", "suppress": True}, # УДАЛЕНО
