...
def capture_screen_area(area: dict):
    ...
    Поддерживает как абсолютные пиксельные значения ('left', 'top', 'width', 'height'),
    так и процентные значения ('left_pct', 'top_pct', 'width_pct', 'height_pct').
    Процентные значения имеют приоритет.
