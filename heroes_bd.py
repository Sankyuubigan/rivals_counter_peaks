...
hero_counters = {
    ...
    "Wolverine": ["Peni Parker", "Iron Man", "Namor", "Storm", "Invisible Woman", "Captain America", "Spider-Man",
                  "Mantis", "Luna Snow", "Magneto", "Hela", "Adam Warlock", "Scarlet Witch"],
