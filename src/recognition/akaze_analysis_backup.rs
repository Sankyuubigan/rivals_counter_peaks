...
/// Рекомендуемые параметры для улучшения работы AKAZE (синхронизированные с Python)
pub const RECOMMENDED_AKAZE_PARAMS: AkazeParams = AkazeParams {
    feature_threshold: 30.0,      // Python: 30.0
    match_threshold: 0.75,        // Python: 0.75
    min_match_count: 3,           // Python: 3
    descriptor_size: 64,         // Python: 64
    min_heroes_for_column: 2,     // Python: 2 (важно!)
};
